...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Tim"",
                    ""type"": ""Button"",
                    ""id"": ""e124ceba-c59f-4107-9762-424c0a054282"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""a49f791e-f747-4c39-be0e-fdebd5ef5947"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""RHsecondary"",
                    ""type"": ""Button"",
                    ""id"": ""f43fa6c1-00ad-41de-b3bf-b060c4dc28f2"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""091072e9-435c-4845-91b7-8461c25b9c43"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHandInteraction_Tim = m_XRILeftHandInteraction.FindAction("Tim", throwIfNotFound: true);
        ...
        m_XRIRightHandInteraction_RHsecondary = m_XRIRightHandInteraction.FindAction("RHsecondary", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHandInteraction_Tim;
    public struct XRILeftHandInteractionActions
    {
        ...
        public InputAction @Tim => m_Wrapper.m_XRILeftHandInteraction_Tim;
        ...
        public void AddCallbacks(IXRILeftHandInteractionActions instance)
        {
            ...
            @Tim.started += instance.OnTim;
            @Tim.performed += instance.OnTim;
            @Tim.canceled += instance.OnTim;
        }
    ...
    private readonly InputAction m_XRIRightHandInteraction_RHsecondary;
    public struct XRIRightHandInteractionActions
    {
        ...
        public InputAction @RHsecondary => m_Wrapper.m_XRIRightHandInteraction_RHsecondary;
        ...
        public void AddCallbacks(IXRIRightHandInteractionActions instance)
        {
            ...
            @TranslateAnchor.performed += instance.OnTranslateAnchor;
            @TranslateAnchor.canceled += instance.OnTranslateAnchor;
            @RHsecondary.started += instance.OnRHsecondary;
            @RHsecondary.performed += instance.OnRHsecondary;
            @RHsecondary.canceled += instance.OnRHsecondary;
        }
    ...
    public interface IXRILeftHandInteractionActions
    {
        ...
        void OnTim(InputAction.CallbackContext context);
    }
    ...
    public interface IXRIRightHandInteractionActions
    {
        ...
        void OnRotateAnchor(InputAction.CallbackContext context);
        void OnTranslateAnchor(InputAction.CallbackContext context);
        void OnRHsecondary(InputAction.CallbackContext context);
    }
